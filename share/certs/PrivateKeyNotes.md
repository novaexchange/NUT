...
unlocked to sign the Nutcoin-Qt.app bundle.
...
allowing somebody to distribute a Nutcoin-Qt.app or nutcoin-qt-setup.exe with a valid
...
that the nutcoin-qt.exe file inside the installer had not been tampered with.
