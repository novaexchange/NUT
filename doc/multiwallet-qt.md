...
In order to support loading of multiple wallets in nutcoin-qt, a few changes in the UI architecture will be needed.
...
Finally, three new headers and source files will have to be added to nutcoin-qt.pro.
...
----------------------
bitcoin.cpp is the entry point into nutcoin-qt, and as such, will require some minor modifications to provide hooks for
