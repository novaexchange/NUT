...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 NTC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 NTC mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 975000000000 * COIN; // 975 milliard de coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 14400 / 250; // 14400 blocks found per day
    }
