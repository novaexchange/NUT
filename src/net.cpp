...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Nutcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"nutcointools.com", "dnsseed.nutcointools.com"},
    {"nutcoinpool.org", "dnsseed.nutcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"nutcointools.com", "testnet-seed.nutcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Nutcoin is probably already running."), addrBind.ToString().c_str());
        else
